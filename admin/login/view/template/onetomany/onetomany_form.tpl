...
<div id="content">
  ...
  <?php $cnt = COUNT($onetomany_description);?>
    <?php for($i=0; $i<$cnt; $i++):?>
          <ul class="nav nav-tabs">
            <?php if($i==0) {$flag=0;for($j=0; $j<$cnt; $j++): ?>
            <li class="<?php echo ($flag==0)?'active':''?>" ><a href="#tab-general_<?php echo $flag;?>" data-toggle="tab" style="background-color: <?php echo ($onetomany_description[$j]['status']==1)?'#f24a24':'#94fc9d'; ?>"><?php echo $onetomany_description[$j]['package_name'];?></a></li>
          <?php $flag++; endfor;}?>
          </ul>
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane active" id="language<?php echo $flag_con; ?>">
                  ...
                  <div class="form-group active">
                    ...
                    <div class="col-sm-4">
                      <input type="text"  value="<?php echo isset($onetomany_description[$j]) ? $onetomany_description[$j]['fname'] : '';?> <?php echo isset($onetomany_description[$j]) ? $onetomany_description[$j]['lname'] : '';?>" placeholder="" id="" class="form-control" readonly/>
                      
                    </div>

                    <label class="col-sm-2 control-label" for=""><?php echo "Package Name"; ?></label>
                    <div class="col-sm-4">
                      <input type="text" value="<?php echo isset($onetomany_description[$j]) ? $onetomany_description[$j]['package_name'] : '';?>" placeholder="" id="" class="form-control" readonly/>
                      <!-- <input type="hidden" name="package_id" value="<?php echo isset($onetomany_description[$j]) ? $onetomany_description[$j]['package_id'] : '';?>" placeholder="" id="" class="form-control" readonly/> -->
                    </div>
                  </div>
<br/>
                  <div class="form-group">
                    ...
                    <div class="col-sm-4">
                      <input type="text" value="<?php echo isset($onetomany_description[$j]) ? $onetomany_description[$j]['package_call'] : '';?>" placeholder="" id="" class="form-control" readonly/>
                      
                    </div>

                    <label class="col-sm-2 control-label" for=""><?php echo "Package Date"; ?></label>
                    <div class="col-sm-4">
                      <input type="text" value="<?php echo isset($onetomany_description[$j]) ? $onetomany_description[$j]['entry_date'] : '';?>" placeholder="" id="" class="form-control" readonly/>
                    </div>
                  </div>
          ...
          <br/>
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-4">
                        <input type="text" value="<?php echo isset($onetomany_description[$j]) ? $onetomany_description[$j]['start_date'] : '';?>" placeholder="" id="" class="form-control" readonly/>
                      ...
                      <div class="col-sm-4">
                         <input type="text" value="<?php echo isset($onetomany_description[$j]) ? $onetomany_description[$j]['end_date'] : '';?>" placeholder="" id="" class="form-control" readonly/>
                      </div>
                  </div>
        <br/>
                  ...
                  <div class="form-group">
                     <label class="col-sm-2 control-label" for=""><?php echo "Package duration"; ?></label>
                        <div class="col-sm-4">
                          <input type="text" value="<?php echo isset($onetomany_description[$j]) ? $onetomany_description[$j]['duration'] : '';?>" placeholder="" id="" class="form-control" readonly/>
                        </div>

                     <label class="col-sm-2 control-label" for=""><?php echo "Customer Comment"; ?></label>
                        <div class="col-sm-4">
                        <textarea placeholder="" id="" class="form-control" readonly><?php echo isset($onetomany_description[$j]) ? $onetomany_description[$j]['comment'] : '';?></textarea>
                        </div>
                  </div>
<br/>
                  ...
                  <div class="col-sm-12 ">
                    <table class="table table-bordered">
                          ...
                          <?php 
                              ...
                              if($onetomany_description[$j]['package_id']==$value['package_id']){
                          ...
                          <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="<?php echo $j;?><?php echo $form_id;?>">
                              <td style="width:100px;">
                                 ...
                                 <input type="hidden" name="package_id" value="<?php echo isset($onetomany_description[$j]) ? $onetomany_description[$j]['package_id'] : '';?>" placeholder="" id="" class="form-control" readonly/>
                                 <input type="hidden" name="customer_id" value="<?php echo isset($onetomany_description[$j]) ? $onetomany_description[$j]['customer_id'] : '';?>" placeholder="" id="" class="form-control" readonly/>
                              </td>
                              <td>
...
<script type="text/javascript">
  function call_start(id){
    ...
    $.ajax({
        type:'POST',
        url: 'index.php?route=onetomany/onetomany/call_start/autocomplete&token=<?php echo $token; ?>',
        dataType: 'json',
        data:formData,
