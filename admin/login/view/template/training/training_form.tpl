              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <textarea name="training_description[<?php echo $language['language_id']; ?>][description]" placeholder="<?php echo $entry_description; ?>"  class="form-control"><?php echo isset($training_description[$language['language_id']]) ? $training_description[$language['language_id']]['description'] : ''; ?></textarea>
                    </div>
                  </div>
                  <div class="form-group">
