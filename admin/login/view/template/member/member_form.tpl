              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="member_description[<?php echo $language['language_id']; ?>][name]" value="<?php echo isset($member_description[$language['language_id']]) ? $member_description[$language['language_id']]['name'] : ''; ?>" placeholder="<?php echo $entry_name; ?>" id="input-name<?php echo $language['language_id']; ?>" class="form-control" />
                      <input type="hidden" id="customer_id" value="<?php echo $member_description[$language['language_id']]['customer_id'];?>">
                  ...
                  <div class="form-group ">
                    <label class="col-sm-2 control-label" for="input-name<?php echo $language['language_id']; ?>"><?php echo "Email Id "; ?></label>
                    <div class="col-sm-3">
                      <input type="text" name="member_description[<?php echo $language['language_id']; ?>][package_amount]" value="<?php echo isset($member_description[$language['language_id']]) ? $member_description[$language['language_id']]['email'] : ''; ?>" placeholder="<?php "email id"; ?>" id="input-name<?php echo $language['language_id']; ?>" class="form-control" />
                      <?php if (isset($error_amount[$language['language_id']])) { ?>
                      <div class="text-danger"><?php echo $error_amount[$language['language_id']]; ?></div>
                      <?php } ?>
                    </div>

                    <label class="col-sm-4 control-label" for="input-name<?php echo $language['language_id']; ?>">Mobile No </label>
                    <div class="col-sm-3">
                      <input type="text" name="member_description[<?php echo $language['language_id']; ?>][package_3m_amount]" value="<?php echo isset($member_description[$language['language_id']]) ? $member_description[$language['language_id']]['telephone'] : ''; ?>" placeholder="<?php echo "mobile no"; ?>" id="input-name<?php echo $language['language_id']; ?>" class="form-control" />
                  ...
                  <div class="form-group required">
                    ...
                    ?>
                      ...
                      <div class="form-group" id="row_id_<?php echo $pack_cnt;?>">
                        ...
                        <?php $id = $member_description[$language['language_id']]['customer_id'];?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <textarea name="member_description[<?php echo $language['language_id']; ?>][description]" placeholder="<?php echo $entry_description; ?>" id="input-description<?php echo $language['language_id']; ?>" class="form-control"><?php echo isset($member_description[$language['language_id']]) ? $member_description[$language['language_id']]['description'] : ''; ?></textarea>
                    </div>
                  </div>
