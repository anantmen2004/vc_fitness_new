          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($package['package_id'], $selected)) { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-left"><?php echo $package['name']; ?></td>
                  <td class="text-right"><?php echo $package['status']; ?></td>
                  <td class="text-right"><a href="<?php echo $package['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                </tr>
                <?php } ?>
                <?php } else { ?>
                <tr>
