          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'name') { ?>
                    ...
                    <?php } ?></td>
                    <td class="text-left">
                    <a  class=""><?php echo "Training Name" ?></a>
                    </td>
                    <td class="text-left">
                    <a  class=""><?php echo "Video Nmae" ?></a>
                    </td>
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($gallery['sr_no'], $selected)) { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $gallery['sr_no']; ?>" checked="checked" />
                    <?php } else { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $gallery['sr_no']; ?>" />
                    <?php } ?></td>
                  <td class="text-left"><?php echo $gallery['name']; ?></td>
                  <td class="text-left"><?php echo $gallery['training_name']; ?></td>
                  <td class="text-left"><?php echo $gallery['video_name']; ?></td>
