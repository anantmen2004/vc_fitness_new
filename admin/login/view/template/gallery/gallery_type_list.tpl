          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($gallery['gallery_type_id'], $selected)) { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $gallery['gallery_type_id']; ?>" checked="checked" />
                    <?php } else { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $gallery['gallery_type_id']; ?>" />
                    <?php } ?></td>
