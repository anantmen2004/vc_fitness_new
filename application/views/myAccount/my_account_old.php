...
<div>
          ...
          <?php $val=$packhistory[$i]['package_call']; ?>
           ...
           ?>
          <input type="text" name="packcall[]" value="<?php echo empty($callnumber1[$i][$p])? $call_cnt : $callnumber1[$i][$p]['call_no']; ?>" placeholder="id" id="pack_call" class="form-control" readonly>          
          <div class="col-md-3">
          <label>Date</label>
            <input type="text" date-date-format=""  class="pickdate" id="packagecall" name="date1[]" placeholder="Select Date" value="<?php echo empty($callnumber1[$i][$p]['date'])? "" : $callnumber1[$i][$p]['date']; ?>" <?php echo (!empty($status) && $status== 2)?"disabled":"";?>/>
          </div>
          <div class="col-md-2">
          <label>Hours</label>
          <select id="hour" name="hour[]" style="height:34px; padding: 3px 0px 0px 10px;" <?php echo (!empty($status) && $status== 2)?"disabled":"";?> >
