                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button  data-toggle="tooltip" title="" class="btn btn-danger" data-original-title="Remove" id="row_<?php echo $items['id'];?>"><a onclick="removeCardItem('<?php echo $items['rowid'];?>','<?php echo $items['id'];?>')"><i class="fa fa-times"></i></a></button>
                                        </td>
                                    </tr>
                                  <?php 
                                    endforeach; 
